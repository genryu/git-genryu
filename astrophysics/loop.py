...
#  Written by Michael J. Jones-Carnegie Mellon University-Dept of Physics
...
# Set constants
G=6.67E-11
initial_speed = 10420.  #Edit to change initial speed
earth.mass = 6.0e24
moon.mass = 7.0e22        #Edit after getting program going
moon.radius= 1.76e6       #Edit after getting program going
ship.mass = 173
dt= 100
scene.autoscale=0
#
...
ship.Vmomentum=vector(0,ship.mass*initial_speed,0)
t = 0
Work=0.
